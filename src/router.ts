...
import nurseAuthRouter from './modules/nurse-auth.controller';
import nursePortalRouter from './modules/nurse-portal.controller';
...
router.get(`${API_PREFIX}/docs`, (req: Request, res: Response) => {
	res.json({
		...
		endpoints: {
			...
			nurseAuth: `${API_PREFIX}/nurse-auth`,
			nursePortal: `${API_PREFIX}/nurse-portal`,
...
router.use(`${API_PREFIX}/nurse-auth`, authLimiter, nurseAuthRouter);

// Protected API routes
router.use(`${API_PREFIX}/appointments`, appointmentRouter);
router.use(`${API_PREFIX}/nurses`, nurseRouter);
router.use(`${API_PREFIX}/nurse-portal`, nursePortalRouter);
...
router.get(`/`, async (req, res, next) => {
	return sendNormalized(
		res,
		StatusCodes.OK,
		{ message: 'Welcome to the LinkBedSides API' },
		'Welcome to the LinkBedSides API'
	);
});
