            ...
            switch (_a.label) {
                case 0:
                    ...
                    config = {
                        ...
                        url: "".concat(constants_1.uris.momo_sandbox, "/v1_0/apiuser"),
                        headers: {
                            'Content-Type': 'application/json',
                            'Ocp-Apim-Subscription-Key': constants_1.EnvironmentVars.getOcpApimSubscriptionKey(),
                            'X-Reference-Id': constants_1.EnvironmentVars.getXReferenceId()
                        },
                        data: data,
                    };
...
exports.default = createMomoAPIUSER;
